      ...
      <section className='font-sans'>
        ...
        <div className="flex justify-center mt-5 text-[#333333]">
            <div className='group flex'>
                ...
                <a href='#'><h1 className='px-3 py-4 text-2xl font-medium group-hover:text-blue-500'>AnyExtractor | Extract Any Files Online.</h1> </a>
            </div>
        </div>
            ...
            <div className='box-content h-[220px] w-[575px] p-4 border-[1.5px] rounded bg-white shadow-slate-300'>
                ...
                <div className='flex m-6'>
                    <div className='flex justify-center text-blue-600 group pl-[90px]'>
                        <a className='flex hover:underline text-[14px]' href='#'>
                ...
                <div className='px-10 py-1'>
                    <div className='text-[13px] text-gray-600 flex flex-col'>
                        <div>
                            ...
                            <a href="#" onClick={spanText} className='px-2 text-[13px] text-blue-600 hover:underline'>and 54 more</a>
                        </div>

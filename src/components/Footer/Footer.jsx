      ...
      <footer className="font-sans mt-[90px] flex">
        <div className="flex">
          ...
          <div className=" text-slate-500 text-[14px] ">
            <button className="hover:underline" href="#">Contact Us</button>
          </div> 
        </div>

        <div className=''>
          <div className="group ml-[800px] flex text-[14px] text-slate-500">
            <a className="flex hover:underline" href="#"> <i className='pr-1 group-hover:text-black'><BsGlobe size='18' /></i> English</a>
          </div>
        </div>
